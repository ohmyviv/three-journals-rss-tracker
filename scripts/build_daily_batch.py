...
def main() -> int:
    ...
    for doi, record in doi_index.items():
        ...
        new_items.append({
            ...
            "china_team_status": record.get("china_team_status", "unknown"),
            "china_institutions": record.get("china_institutions", []),
            "china_key_authors": record.get("china_key_authors", []),
            "china_team_evidence": record.get("china_team_evidence", []),
